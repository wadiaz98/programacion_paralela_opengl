...
//        glfwSetKeyCallback(window, []  window, int key, int scancode, int action, int mods) {
...
//
//
//                pixel_buffer[py * Params.WIDTH + px] = (iteration == maxIteration) ? black: Params.color_ramp[iteration%Params.PALETTE_SIZE];
//            }
//        }
//
//        // Dibuja la textura
